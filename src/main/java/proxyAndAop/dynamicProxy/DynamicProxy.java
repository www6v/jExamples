package proxyAndAop.dynamicProxy;
...
public class DynamicProxy {
    ...
    private static void createProxy() throws Exception
    {
    	...
    	//设置接口
    	CtClass interface1 = pool.get("proxyAndAop.dynamicProxy.TicketService");
    	cc.setInterfaces(new CtClass[]{interface1});
    	
    	//设置Field
    	CtField field = CtField.make("private proxyAndAop.dynamicProxy.Station station;", cc);
    	
    	cc.addField(field);
    	
    	CtClass stationClass = pool.get("proxyAndAop.dynamicProxy.Station");
