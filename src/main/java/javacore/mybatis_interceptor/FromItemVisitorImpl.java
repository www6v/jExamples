...
//            List<TableCondition> test = UserUtils.getTableCondition(tableName.getFullyQualifiedName().toUpperCase());
            List<TableCondition> test = new ArrayList();
            TableCondition tableCondition1 = new TableCondition();
            tableCondition1.setOperator("where");
            tableCondition1.setFieldName("abc");
            tableCondition1.setFieldValue("123");
